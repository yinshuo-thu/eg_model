...
until grep -aq "xfmr] done" Transformer/v1/log_train8.txt 2>/dev/null; do sleep 20; done
...
echo "--- transformer ---" >> finalize.log; cat Transformer/v1/metrics/leaderboard.csv >> finalize.log
