"""Shared utilities for the NEW-FEATURES (nf) experiment: same interface as common.py,
but reads the extended feature set (artifacts/features_nf.parquet). common.py /
features.parquet are never touched."""
...
def feature_cols() -> list[str]:
    return json.loads((ROOT / "artifacts" / "feature_list_nf.json").read_text())
