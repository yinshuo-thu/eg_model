...
from common_nf import load, feature_cols, evaluate, print_row
...
TAG      = env("TAG", "transformer_nf")
OUTPRED  = env("OUTPRED", "transformer_nf")
...
def main():
    ...
    lb = ROOT / "Transformer" / "v1" / "metrics" / "leaderboard_nf.csv"
    row = pd.DataFrame([r])
